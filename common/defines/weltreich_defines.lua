...
NDefines.NCareerProfile.MOD_STATISTICS_GROUP_NAME = "WELTREICH_CAREER_PROFILE"
	
-- General AI
NDefines.NAI.DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 0.1					-- Vanilla is 0.2
NDefines.NAI.DIPLOMACY_FACTION_PLAYER_JOIN = 0								-- Vanilla is 20

NDefines.NAI.DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 20						-- Vanilla is 50
...
NDefines.NCountry.NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 1.0;
NDefines.NCountry.THERMONUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 10.0;
NDefines.NRaids.NUCLEAR_BOMB_MIN_DAMAGE_PERCENT = 1.0;		
NDefines.NRaids.NUCLEAR_BOMB_MAX_DAMAGE_PERCENT = 1.1;		
NDefines.NRaids.THRMONUCLEAR_BOMB_MIN_DAMAGE_PERCENT = 1.0;	
NDefines.NRaids.THERMONUCLEAR_BOMB_MAX_DAMAGE_PERCENT = 1.1;	